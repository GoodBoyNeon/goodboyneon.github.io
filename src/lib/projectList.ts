...
export const majorProjects: Project[] = [
  {
    name: "Sprofile",
    description:
      "Blazingly fast TUI application for viewing your Spotify listening activity. Sprofile is written in rust. It includes an authorization backend, and a frontend TUI written using the RataTUI library.",
    tags: ["CLI", "rust", "TUI", "data", "auth"],
  ...
  },
  {
    name: "tictactoe",
    description:
      "A CUI powered tictactoe bot written in C++. It uses the minimax algorithm to determine the best move in any given position, ensuring it never loses from an equal position, all wrapped in a ncurses CUI.",
    githubUrl: "https://github.com/goodboyneon/tictactoe",
    image: "./projectImages/tictactoe.png",
    tags: ["tic-tac-toe", "C++", "minimax", "CUI"],
  },
];
export const minorProjects: Project[] = [
  ...
  },
  {
    name: "Print Wizard",
    description:
      "A python port of my npm package, console-wizard. It provides all the features of console-wizard, but in a python codebase. Try it using pip install printwizard",
